        ...
        <div class="row">
            <div class="span4">
                <ul class="nav nav-pills">
                    <li><a href="#"><i class="icon-th-large"></i>Large Grid</a></li>
                    <%--  <li class="active"><a href="page-search-browse-filter-small-grid.html"><i class="icon-th icon-white"></i>Small Grid</a></li>
                    <li><a href="page-search-browse-filter-list-view.html"><i class="icon-th-list"></i>List View</a></li>--%>
                    <li>
                ...
                <li class="span2">
                    <div class="thumbnail">
                        ...
                        <div class="caption">
                            ...
                            <hr />
                            <div class="btn-group">
                                <a class="btn btn-info" href="<%# ResolveUrl(StoreHelper.GetEntryUrl((Entry) Container.DataItem)) %>"><i class="icon-shopping-cart icon-white"></i>View Detail</a> <a class="btn btn-info dropdown-toggle" data-toggle="dropdown" href="#"><span class="caret"></span></a>
            ...
            <ItemTemplate>
                <tr>
                    ...
                    <td style="width: 60%;">
                        ...
                        <br />
                        SKU: <strong>1238172-A34638</strong>
                        <br />
                        Inventory:<strong>
