...
GO
PRINT N'Creating unnamed constraint on [dbo].[tblWindowsGroup]...';
...
GO
PRINT N'Creating [dbo].[DF__tblContentLanguage__Created]...';
...
GO
PRINT N'Creating [dbo].[DF__tblContentLanguage__Changed]...';
...
GO
PRINT N'Creating [dbo].[DF__tblContentLanguage__Saved]...';
...
GO
PRINT N'Creating [dbo].[DF_tblUnifiedPathAcl_IsRole]...';
...
GO
PRINT N'Creating [dbo].[DF_tblUnifiedPath_InheritAcl]...';
...
GO
PRINT N'Creating [dbo].[DF__tblWorkPa__Creat__49AEE81E]...';
...
GO
PRINT N'Creating [dbo].[DF__tblWorkPa__Saved__4AA30C57]...';
...
GO
PRINT N'Creating [dbo].[DF_tblTask_Created]...';
...
GO
PRINT N'Creating [dbo].[DF_tblTask_Changed]...';
...
GO
PRINT N'Creating [dbo].[DF_tblPlugIn_Accessed]...';
...
GO
PRINT N'Creating [dbo].[DF_tblPlugIn_Created]...';
...
GO
PRINT N'Creating [dbo].[DF_tblContentType_Registered]...';
...
GO
PRINT N'Creating [dbo].[FK_tblWindowsRelations_Group]...';
...
GO
PRINT N'Creating [dbo].[FK_tblWindowsRelations_User]...';
...
GO
PRINT N'Creating [dbo].[FK_tblRelation_tblItem_FromId]...';
...
GO
PRINT N'Creating [dbo].[FK_tblRelation_tblItem_ToId]...';
...
GO
PRINT N'Creating [dbo].[FK_tblSchemaItem_tblSchema]...';
...
GO
PRINT N'Creating [dbo].[FK_tblUnifiedPathProperty_tblUnifiedPath]...';
...
GO
PRINT N'Creating [dbo].[FK_tblUnifiedPathAcl_tblUnifiedPath]...';
