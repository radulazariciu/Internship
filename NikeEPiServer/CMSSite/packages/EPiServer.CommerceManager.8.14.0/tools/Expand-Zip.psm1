function Expand-Zip
{
    ...
    # If zip file doesn't exist we exit
    if (!$zipFilePath -or !(Test-Path $zipFilePath))
    {
        Write-Host "Could not find zip at: ""$zipFilePath"""
        return
    }
    Write-Host "Expanding $zipFilePath into $destinationPath and overwriting any existing files"
    # http://serverfault.com/questions/18872/how-to-zip-unzip-files-in-powershell
    $shell = new-object -com shell.application
    $zip_file = $shell.namespace($zipFilePath)
    $destination = $shell.namespace($destinationPath)
    $destination.Copyhere($zip_file.items(), 0x10) #0x10 to overwrite existing files
}
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQULExz/7fiK9fBYQiD+qu/+liG
# 3AGgghP/MIID7jCCA1egAwIBAgIQfpPr+3zGTlnqS5p31Ab8OzANBgkqhkiG9w0B
...
# BgorBgEEAYI3AgEVMCMGCSqGSIb3DQEJBDEWBBQ+YAMrbnm+MibEQcWfLfzEnubx
# 7DANBgkqhkiG9w0BAQEFAASCAQCEgUhgH43uKbBM3+AB7z/Rl0yoXpArCmeJ4Er5
# RnRo8A8MiF81yKhEPWA9DNm0Icbd2qhwgxseV0+J0HNj80Ek1spkM30pHRbrehNz
# 4hvct1vyZdVg15KQ81sP9AlV2pipLL5mzw5hWbbWSQKQLdp/6yqRFPCH8PMea7uX
# NXq0nNhrKPBSaydrJ2ej47hiax8yiSfVaN0w4aV0VpkIaj6Cu61BLc/jjGw5KQfD
# scpF0G0b89sn1nt+da5HcXBYyg4NSJerp7ucJjGYerUEWNPJkBjuhYkfhdHExrEr
# zAQDeNU7DiD+wmwtlPcMPfHPzSDRN0fMQlFRgqMnPTUQMVLeoYICCzCCAgcGCSqG
...
# MDcwNzE0NDAzNlowIwYJKoZIhvcNAQkEMRYEFC31Rs6vkfKLFxrFuHBYyYMPtRR+
# MA0GCSqGSIb3DQEBAQUABIIBAA8KsRtvxMAyBM8gT9tdtLAt2toEiYnWvQ+P3Y11
# jCDUTM2VXJH3yX93/3hcjokYhhbeGMmV1WUxp3M+8LADK9FLQ25BtTmQKn/hQ+nA
# 9cL58w/CdIhpzcAY6gZwXk8Rbj5VS8IWqjc+nV+VLoL/gPyn2Q+LbiaOMKH+P2qF
# 1kHNmKC+QSTeO79gI72H5kraAtlKdGkv8iIHKiNvA2ZZ1JvOnx7WVPSeZK8qLLlX
# v5dkUcU65YzwdbV9u7WkI6qcvXhC2P8BvoiMauDHKYb+3lwDt7dBCqDgfKZpuffx
# HxGJ0oO2fAV5TjKs+B/H1Ia9YRnLVDWUcRQdze0max657S4=
