function Set-CommerceManagerSharedNotificationTemplatesPath([xml]$xml, [string]$CommerceManagerPath)
{
	$node = $xml.SelectSingleNode("//templateService/providers/add[@name='XslTemplateProvider']");
	if($node -ne $null)
	{
		$node.SetAttribute("templateSource", $CommerceManagerPath + "\NotificationTemplates\{0}\{1}.xsl");
	}
}
# SIG # Begin signature block
# MIIZDwYJKoZIhvcNAQcCoIIZADCCGPwCAQExCzAJBgUrDgMCGgUAMGkGCisGAQQB
# gjcCAQSgWzBZMDQGCisGAQQBgjcCAR4wJgIDAQAABBAfzDtgWUsITrck0sYpfvNR
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQURYIkbF+Z/34vGge52R4UIbS5
# hBWgghP/MIID7jCCA1egAwIBAgIQfpPr+3zGTlnqS5p31Ab8OzANBgkqhkiG9w0B
...
# BgorBgEEAYI3AgEVMCMGCSqGSIb3DQEJBDEWBBTzZ5MHtW818tvRDtwVwafm+dU2
# 3zANBgkqhkiG9w0BAQEFAASCAQCaDc6NSb6fVNBwsFc3h1IQEpl1DZ95hfrI6kTg
# CbgD/Y5BU2hWNsoI9PbQJpakMKFDygrDTBklVNCBsO7QZr6SYB9Yoy2vapqkvxqb
# z+hf3COFJqAUUnphej+JEOwNwZNVrdvhwCKRjOcKlbXQDSoC5H30SmgVxzW0BXSc
# bQA6tJge+B1rSNFFSxOW9DqlKTN+zkkEJZmNVaRoZAuXRlwbR5oif5FPtfxAAokW
# 49LJCWR5MD6/LPudAFGEmQAjS80bvHWyYeynbJDxUy2NczrQBFHOgpZf7ewJit3N
# 45SC94DaqDQRMCnL0IodnjviajfYEm9pHKU/dCSD/CZymsD3oYICCzCCAgcGCSqG
...
# MDcwNzE0NDAzNlowIwYJKoZIhvcNAQkEMRYEFNUKruR2ZsJBmKwS9MNoltfEeBN8
# MA0GCSqGSIb3DQEBAQUABIIBAI22c8r/h2/Y58RG5xD8vES4k3CTPC7Z22Fo7ILm
# gr94KXeZs+V6PBH++MTPxLj2ZafExd2OFFRAUE7y1oVFNFxMSUWtJGlp+vJXE7ql
# QsIZVS2wglT1q8ax+HidhhgZ2enc0rmC+Cp7bonp/Y8i85YA0NbwMGLGS70igJWb
# Ki/DDLtbthmdfj3VMpQzTVNt12yCSelckaTxvdcaRaUd7eVXlh0VqUyNINRytRGO
# 7tTvT8O5WMFCzlDWVmMEqBe3qYpJ/gWqZgCoxGyM4UZ5ekAW+x1lmU8nO4PaaSDY
# SM4opGUJ7rm/FTxelb/1TFsRj2zf2c9d6m1ZRNQtNbAUppQ=
