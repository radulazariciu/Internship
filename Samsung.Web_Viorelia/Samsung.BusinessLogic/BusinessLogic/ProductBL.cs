...
namespace Samsung.BusinessLogic.BusinessLogic
{
    public static class ProductBL
    {
        ...
        {
            ProductMapper productMapper = new ProductMapper();
            Product inputProduct = new Product(productVM.Id, productVM.Name, productVM.Category, productVM.Color, productVM.Details, Convert.ToInt32(productVM.Price), productVM.Stock);
